...
```javascript
stderr = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-stderr@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-stderr@umd/bundle.js"></script>
```
